...
const APPLE_WATCH_SERIES_11_CONFIG: ProductConfig = {
  ...
  prices: [
    ...
    { storageId: "46mm", colorId: "silver", simId: "none", price: 36000 },
    { storageId: "46mm", colorId: "space", simId: "none", price: 36000 },
  ],
  defaultStorage: "46mm",
  defaultColor: "silver",
  defaultSim: "none",
...
const APPLE_WATCH_SE_3_CONFIG: ProductConfig = {
  ...
  prices: [
    ...
    { storageId: "44mm", colorId: "starlight", simId: "none", price: 27500 },
  ],
  defaultStorage: "44mm",
...
const APPLE_WATCH_SE_2_CONFIG: ProductConfig = {
  ...
  prices: [
    { storageId: "44mm", colorId: "midnight", simId: "none", price: 21500 },
  ],
  defaultStorage: "44mm",
