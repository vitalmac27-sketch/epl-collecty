...
const SAMSUNG_GALAXY_S26_ULTRA_CONFIG: ProductConfig = {
  ...
  specs: [
    ...
    { label: "Дисплей", value: "6,9\" QHD+ AMOLED 120 Гц" },
    { label: "Камера", value: "200 МП + 50 МП + 50 МП + 12 МП" },
    { label: "S Pen", value: "Да" },
    { label: "Батарея", value: "5000 мАч" },
    { label: "Корпус", value: "Титан" },
  ],
  compareTitle: "Galaxy S25 Ultra",
  compare: [
...
const SAMSUNG_GALAXY_S26_PLUS_CONFIG: ProductConfig = {
  ...
  specs: [
    { label: "Процессор", value: "Snapdragon 8 Elite Gen 5" },
    { label: "Дисплей", value: "6,7\" QHD+ AMOLED" },
    { label: "Камера", value: "50+50+12 МП" },
    { label: "Батарея", value: "4900 мАч" },
  ],
  compareTitle: "Galaxy S25+",
  compare: [
  ],
  upsell: UPSELL,
...
const SAMSUNG_GALAXY_S26_CONFIG: ProductConfig = {
  ...
  specs: [
    { label: "Процессор", value: "Snapdragon 8 Elite Gen 5" },
    { label: "Дисплей", value: "6,2\" FHD+ AMOLED" },
    { label: "Камера", value: "50+50+12 МП" },
  ],
  compareTitle: "Galaxy S25",
  compare: [
...
const SAMSUNG_GALAXY_S25_ULTRA_CONFIG: ProductConfig = {
  ...
  specs: [
    ...
    { label: "Дисплей", value: "6,9\" QHD+ AMOLED" },
    { label: "Камера", value: "200+50+50+10 МП" },
    { label: "S Pen", value: "Да" },
  ],
  compareTitle: "Galaxy S24 Ultra",
  compare: [
  ],
  upsell: UPSELL,
...
const SAMSUNG_GALAXY_S25_FE_CONFIG: ProductConfig = {
  ...
  specs: [
    ...
    { label: "Дисплей", value: "6,7\" FHD+ AMOLED" },
    { label: "Камера", value: "50+12+8 МП" },
  ],
  compareTitle: "Galaxy S24 FE",
  compare: [
  ],
  upsell: UPSELL,
...
const SAMSUNG_GALAXY_A26_CONFIG: ProductConfig = {
  ...
  specs: [
    ...
    { label: "Дисплей", value: "6,5\" FHD+ Super AMOLED" },
  ],
  compareTitle: "Galaxy A25",
  compare: [
  ],
  upsell: UPSELL,
