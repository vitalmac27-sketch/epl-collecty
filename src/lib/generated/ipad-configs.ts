...
const IPAD_AIR_11_M4_CONFIG: ProductConfig = {
  ...
  prices: [
    ...
    { storageId: "256", colorId: "starlight", simId: "wifi", price: 79000 },
  ],
  defaultStorage: "128",
  defaultColor: "gray",
  defaultSim: "wifi",
