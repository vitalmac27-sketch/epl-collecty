/** ipad-configs.ts — АВТОГЕНЕРАЦИЯ (не редактировать вручную) */
import type { ProductConfig, UpsellItem } from "../product-configs";

const UPSELL: UpsellItem[] = [
  { id: "apple-pencil", name: "Apple Pencil Pro", description: "Для рисования, заметок, документов. Магнитная зарядка.", price: 14900, emoji: "✏️" },
  { id: "magic-keyboard", name: "Magic Keyboard для iPad", description: "Тачпад, подсветка клавиш, USB-C для зарядки.", price: 19900, emoji: "⌨️" },
  { id: "ipad-case", name: "Smart Folio чехол", description: "Защита экрана, функция подставки. Оригинал Apple.", price: 3490, emoji: "📱" },
...
const IPAD_11_2025_CONFIG: ProductConfig = {
  ...
  seoText: "iPad 11 (2025) — популярный планшет Apple в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 36 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
  seoH2Why: "Почему iPad 11 (2025) стоит купить у нас?",
  seoTextWhy: "В ЭПЛ-КОЛЛЕКЦИЯ каждый iPad 11 (2025) проходит проверку перед продажей: тестируем все функции, проверяем серийный номер по базе Apple, активируем и настраиваем устройство прямо в магазине.",
};
...
const IPAD_AIR_11_M3_CONFIG: ProductConfig = {
  ...
  category: "ipad",
  colors: [
    { id: "gray", name: "Серый (Space Gray)", hex: "#4E4E4F", image: "ipad-air-11-m3" },
  ...
  seoText: "iPad Air 11\" M3 — популярный планшет Apple в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 53 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
  seoH2Why: "Почему iPad Air 11\" M3 стоит купить у нас?",
  seoTextWhy: "В ЭПЛ-КОЛЛЕКЦИЯ каждый iPad Air 11\" M3 проходит проверку перед продажей: тестируем все функции, проверяем серийный номер по базе Apple, активируем и настраиваем устройство прямо в магазине.",
};
...
const IPAD_AIR_11_M4_CONFIG: ProductConfig = {
  ...
  category: "ipad",
  colors: [
    { id: "gray", name: "Серый (Space Gray)", hex: "#4E4E4F", image: "ipad-air-11-m4" },
  ...
  seoText: "iPad Air 11\" M4 — популярный планшет Apple в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 55 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
  seoH2Why: "Почему iPad Air 11\" M4 стоит купить у нас?",
  seoTextWhy: "В ЭПЛ-КОЛЛЕКЦИЯ каждый iPad Air 11\" M4 проходит проверку перед продажей: тестируем все функции, проверяем серийный номер по базе Apple, активируем и настраиваем устройство прямо в магазине.",
};
...
const IPAD_PRO_11_CONFIG: ProductConfig = {
  ...
  compare: [
    ...
    { label: "Дисплей", current: "OLED 120 Гц", previous: "OLED 120 Гц", better: false },
  ],
  upsell: UPSELL,
  seoH2: "Купить iPad Pro 11\" M5 в Казани",
  seoText: "iPad Pro 11\" M5 — популярный планшет Apple в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 84 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
  seoH2Why: "Почему iPad Pro 11\" M5 стоит купить у нас?",
  seoTextWhy: "В ЭПЛ-КОЛЛЕКЦИЯ каждый iPad Pro 11\" M5 проходит проверку перед продажей: тестируем все функции, проверяем серийный номер по базе Apple, активируем и настраиваем устройство прямо в магазине.",
};
...
const IPAD_PRO_13_CONFIG: ProductConfig = {
  ...
  seoText: "iPad Pro 13\" M5 — популярный планшет Apple в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 157 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
  seoH2Why: "Почему iPad Pro 13\" M5 стоит купить у нас?",
  seoTextWhy: "В ЭПЛ-КОЛЛЕКЦИЯ каждый iPad Pro 13\" M5 проходит проверку перед продажей: тестируем все функции, проверяем серийный номер по базе Apple, активируем и настраиваем устройство прямо в магазине.",
  seoH2Sim: "Wi-Fi или Wi-Fi + Cellular?",
  seoTextSim: "Wi-Fi — дешевле и для дома/офиса. Cellular (LTE) — мобильный интернет в любом месте через eSIM.",
};
