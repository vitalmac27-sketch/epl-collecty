...
const MAC_MINI_M4_CONFIG: ProductConfig = {
  ...
  prices: [
    { storageId: "16-256", colorId: "silver", simId: "none", price: 54000 },
  ],
  ...
  seoText: "Mac mini M4 — популярный ноутбук в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 54 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
...
const MACBOOK_NEO_CONFIG: ProductConfig = {
  ...
  category: "macbook",
  colors: [
    { id: "blush", name: "Blush", hex: "#888888", image: "macbook-neo" },
  ...
  storage: [
    { id: "8-512", label: "8 ГБ / 512 ГБ SSD", available: true },
  ...
  prices: [
    { storageId: "8-512", colorId: "silver", simId: "none", price: 81500 },
    { storageId: "8-512", colorId: "indigo", simId: "none", price: 79000 },
    { storageId: "8-512", colorId: "blush", simId: "none", price: 83000 },
    { storageId: "8-512", colorId: "citrus", simId: "none", price: 77500 },
    { storageId: "8-256", colorId: "blush", simId: "none", price: 71000 },
    { storageId: "8-256", colorId: "citrus", simId: "none", price: 70000 },
    { storageId: "8-256", colorId: "indigo", simId: "none", price: 70000 },
  ...
  seoText: "MacBook Neo — популярный ноутбук в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 59 500 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
...
const MACBOOK_AIR_13_M2_CONFIG: ProductConfig = {
  ...
  prices: [
    { storageId: "16-256", colorId: "midnight", simId: "none", price: 72500 },
  ],
  defaultStorage: "16-256",
  ...
  seoText: "MacBook Air 13\" M2 — популярный ноутбук в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 72 500 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
...
const MACBOOK_AIR_13_M5_CONFIG: ProductConfig = {
  ...
  category: "macbook",
  colors: [
    { id: "midnight", name: "Тёмная ночь", hex: "#888888", image: "macbook-air-13-m5" },
  ...
  prices: [
    ...
    { storageId: "16-512", colorId: "midnight", simId: "none", price: 130000 },
    { storageId: "16-512", colorId: "silver", simId: "none", price: 133000 },
    { storageId: "16-512", colorId: "skyblue", simId: "none", price: 130000 },
    { storageId: "16-512", colorId: "starlight", simId: "none", price: 130000 },
  ],
  ...
  seoText: "MacBook Air 13\" M5 — популярный ноутбук в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 95 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
...
const MACBOOK_AIR_15_M4_CONFIG: ProductConfig = {
  ...
  prices: [
    { storageId: "16-256", colorId: "skyblue", simId: "none", price: 104000 },
    { storageId: "16-512", colorId: "skyblue", simId: "none", price: 112000 },
  ],
  defaultStorage: "16-256",
  defaultColor: "skyblue",
  defaultSim: "none",
  ...
  seoText: "MacBook Air 15\" M4 — популярный ноутбук в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 104 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
...
const MACBOOK_AIR_15_M5_CONFIG: ProductConfig = {
  ...
  prices: [
    { storageId: "16-512", colorId: "midnight", simId: "none", price: 147000 },
    { storageId: "16-512", colorId: "silver", simId: "none", price: 155000 },
    { storageId: "16-512", colorId: "skyblue", simId: "none", price: 147000 },
    { storageId: "16-512", colorId: "starlight", simId: "none", price: 145000 },
  ],
  defaultStorage: "16-512",
  defaultColor: "skyblue",
  defaultSim: "none",
  ...
  seoText: "MacBook Air 15\" M5 — популярный ноутбук в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 111 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
...
const MACBOOK_PRO_14_M5_CONFIG: ProductConfig = {
  ...
  seoText: "MacBook Pro 14\" M5 — популярный ноутбук в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 127 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
...
const MACBOOK_PRO_14_M5_PRO_CONFIG: ProductConfig = {
  ...
  prices: [
    { storageId: "24-1tb", colorId: "black", simId: "none", price: 184000 },
  ],
  ...
  seoText: "MacBook Pro 14\" M5 Pro — популярный ноутбук в магазине ЭПЛ-КОЛЛЕКЦИЯ в Казани. Цена от 184 000 ₽. Оригинал с гарантией 1 год, рассрочка 0% на 10 месяцев, бесплатная доставка в день заказа.",
