...
export const allModels: ProductModel[] = [
  {
    ...
    name: "Ray-Ban Headliner",
    category: "glasses",
    series: "glasses",
    priceFrom: 36000,
    image: "airpods-max",
    seoTitle: "Купить Ray-Ban Headliner в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "Ray-Ban Headliner в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Классика Ray-Ban",
    inNav: true,
  },
  {
    ...
    priceFrom: 37000,
    image: "airpods-max",
    seoTitle: "Купить Ray-Ban Wayfarer в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "Ray-Ban Wayfarer в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Легендарная форма",
    inNav: true,
  },
  {
    slug: "meta-glasses-starfire",
    name: "Meta Glasses Starfire",
    category: "glasses",
    series: "glasses",
    priceFrom: 52000,
    image: "airpods-max",
    seoTitle: "Купить Meta Glasses Starfire в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "Meta Glasses Starfire в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Умные очки с камерой",
    inNav: true,
  },
  {
    slug: "gopro-hero-13",
    ...
    priceFrom: 31000,
    image: "dji-mic-3",
    seoTitle: "Купить GoPro Hero 13 в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "GoPro Hero 13 в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Флагманская экшн-камера",
    inNav: true,
  },
  {
    slug: "gopro-hero-12",
    ...
    priceFrom: 27000,
    image: "dji-mic-3",
    seoTitle: "Купить GoPro Hero 12 в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "GoPro Hero 12 в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Экшн-камера",
    inNav: true,
  },
  {
    slug: "insta360-x5",
    ...
    priceFrom: 39500,
    image: "dji-mic-3",
    seoTitle: "Купить Insta360 X5 в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "Insta360 X5 в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Панорамная 360°",
    inNav: true,
  },
  {
    ...
    priceFrom: 13000,
    image: "dji-mic-3",
    seoTitle: "Купить DJI Osmo Mobile 8 в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "DJI Osmo Mobile 8 в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Стабилизатор с лидаром",
    inNav: true,
  },
  {
    slug: "dji-osmo-mobile-8p",
    name: "DJI Osmo Mobile 8P",
    category: "cameras",
    series: "cameras",
    priceFrom: 16000,
    image: "dji-mic-3",
    seoTitle: "Купить DJI Osmo Mobile 8P в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "DJI Osmo Mobile 8P в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Стабилизатор для смартфона",
    inNav: true,
  },
  {
    ...
    priceFrom: 38000,
    image: "dji-mic-3",
    seoTitle: "Купить DJI Osmo Pocket 3 в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "DJI Osmo Pocket 3 в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Карманная камера",
    inNav: true,
  },
  {
    ...
    priceFrom: 43000,
    image: "dji-mic-3",
    seoTitle: "Купить DJI Osmo Pocket 4 в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "DJI Osmo Pocket 4 в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Карманная камера 4K",
    inNav: true,
  },
  {
    ...
    priceFrom: 104000,
    image: "dji-mic-3",
    seoTitle: "Купить Canon PowerShot G7X Mark III в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "Canon PowerShot G7X Mark III в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Компакт для блогеров",
    inNav: true,
  },
  {
    slug: "kodak-charmera",
    ...
    priceFrom: 5500,
    image: "dji-mic-3",
    seoTitle: "Купить Kodak Charmera в Казани | ЭПЛ-КОЛЛЕКЦИЯ",
    seoDescription: "Kodak Charmera в Казани ✅ Оригинал, гарантия 1 год, рассрочка 0%, доставка.",
    subtitle: "Мини-камера-брелок",
    inNav: true,
  },
