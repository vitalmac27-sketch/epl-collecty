...
import { getModelUrl, getModelMinStorage } from "@/lib/models";
    ...
    <section aria-label={title}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        {models.map((model) => {
          ...
          const minStorage = getModelMinStorage(model);
          return (
            <Card
              key={model.slug}
            ...
            >
              ...
              <Link
                ...
                className="aspect-square bg-muted/30 p-3 flex items-center justify-center"
              >
                <Image
